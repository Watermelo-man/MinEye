...
class controller():
    ...
    kernel = None
    def __init__(self):
         self.kernel = universal_model.kernel.kernel(model_path="C:\\Users\\CNT\\Desktop\\ul_git_source\\ourmodels\\onlygold.pt", device="CPU")
    ...
    def selectSource(self,src:int = 2):
        if src == 1:
