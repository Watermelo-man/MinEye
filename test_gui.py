...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        #Turn on camera
        self.camera_btn = QtWidgets.QPushButton(parent=self.centralwidget)
        self.camera_btn.setGeometry(QtCore.QRect(840, 570, 411, 41))
        font = QtGui.QFont()
        font.setFamily("HelveticaNowDisplay Bold")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.camera_btn.setStyleSheet("background-color: rgb(126, 126, 126);\n"
                                      "selection-background-color: rgb(0, 0, 0);\n"
                                      "gridline-color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.camera_btn.setText(_translate("MainWindow", "Сamera mode"))
